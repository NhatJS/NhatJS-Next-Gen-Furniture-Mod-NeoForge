...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> TRASH_CAN_BLACK = registerBlock("trash_can_black",
            () -> new TrashCanBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.2F).noOcclusion()));
    ...
    public static final DeferredBlock<Block> FLOOR_LAMP = registerBlock("floor_lamp",
            () -> new FloorLampBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0F).noOcclusion()));
